...
class Twig_Tests_Extension_SandboxTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testSandboxUnallowedMethodAccessor()
    {
        ...
        try {
            ...
            $this->assertInstanceOf('Twig_Sandbox_SecurityNotAllowedMethodError', $e, 'Exceptions should be an instance of Twig_Sandbox_SecurityNotAllowedMethodError');
            $this->assertEquals('FooObject', $e->getClassName(), 'Exceptions should be raised on the "FooObject" class');
            $this->assertEquals('foo', $e->getMethodName(), 'Exceptions should be raised on the "foo" method');
        }
    }
    ...
    public function testSandboxUnallowedFilter()
    {
        ...
        try {
            ...
            $this->assertInstanceOf('Twig_Sandbox_SecurityNotAllowedFilterError', $e, 'Exceptions should be an instance of Twig_Sandbox_SecurityNotAllowedFilterError');
            $this->assertEquals('upper', $e->getFilterName(), 'Exceptions should be raised on the "upper" filter');
        }
    }
    ...
    public function testSandboxUnallowedTag()
    {
        ...
        try {
            ...
            $this->assertInstanceOf('Twig_Sandbox_SecurityNotAllowedTagError', $e, 'Exceptions should be an instance of Twig_Sandbox_SecurityNotAllowedTagError');
            $this->assertEquals('if', $e->getTagName(), 'Exceptions should be raised on the "if" tag');
        }
    }
    ...
    public function testSandboxUnallowedProperty()
    {
        ...
        try {
            ...
            $this->assertInstanceOf('Twig_Sandbox_SecurityNotAllowedPropertyError', $e, 'Exceptions should be an instance of Twig_Sandbox_SecurityNotAllowedPropertyError');
            $this->assertEquals('FooObject', $e->getClassName(), 'Exceptions should be raised on the "FooObject" class');
            $this->assertEquals('bar', $e->getPropertyName(), 'Exceptions should be raised on the "bar" property');
        }
    }
    ...
    public function testSandboxUnallowedToString()
    {
        ...
        try {
            ...
            $this->assertInstanceOf('Twig_Sandbox_SecurityNotAllowedMethodError', $e, 'Exceptions should be an instance of Twig_Sandbox_SecurityNotAllowedMethodError');
            $this->assertEquals('FooObject', $e->getClassName(), 'Exceptions should be raised on the "FooObject" class');
            $this->assertEquals('__tostring', $e->getMethodName(), 'Exceptions should be raised on the "__toString" method');
        }
    }
    ...
    public function testSandboxUnallowedFunction()
    {
        ...
        try {
            ...
            $this->assertInstanceOf('Twig_Sandbox_SecurityNotAllowedFunctionError', $e, 'Exceptions should be an instance of Twig_Sandbox_SecurityNotAllowedFunctionError');
            $this->assertEquals('cycle', $e->getFunctionName(), 'Exceptions should be raised on the "cycle" function');
        }
    }
